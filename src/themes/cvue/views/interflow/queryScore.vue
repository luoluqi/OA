<template>
    <div class="home">
                ...
                <el-form ref="ruleForm" label-width="60px" @submit.native.prevent>
                    <el-row :gutter="10">
                        ...
                        <el-col :span="4" style="text-align:right">
                            <!-- <el-button size="mini" @click="handleAdd" v-hasPermission="permission.add">退出</el-button> -->
                        </el-col>
                    </el-row>
                </el-form>
            </div>
                ...
                <cvue-table :option="tableOption" :data="tableData" ref="tbl1"
                    ...
                    <el-table-column fixed="right" slot="actionMenu" label="操作" align="center"
                        ...
                        <template slot-scope="scope">
                            <el-button type="text" size="small" @click="getRecord(scope.row)">查询成绩</el-button>
                        </template>
                    </el-table-column>
                </cvue-table>
            </div>
        ...
        <view-score-dialog
                :isFullscreen = "true"
                @closeDialog="closeDialog('view')"
                @confirmDialog="confirmDialog('view')"
                @handleClose="closeDialog('view')"
...
export default {
    ...
    methods: {
        ...
        handleList (classId, schoolyearId, schooltermid) {
            ...
            this.$store.dispatch('interflow/GetQueryScoreList', params).then(res => {
                // console.log(res)
